...
GameStates.makePreloader = function( game ) {
    ...
    return {
        ...
        preload: function () {
            ...
            game.load.audio('thrust', 'assets/thrust.wav');
            game.load.audio('explode', 'assets/bangSmall.wav');
            game.load.audio('break', 'assets/bangLarge.wav');
            game.load.audio('newboid', 'assets/extraShip.wav');
